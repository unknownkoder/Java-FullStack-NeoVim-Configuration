...
This configuration repository goes along with my tutorial on how to setup NeoVim for Java Developers, which you can find [here](www.youtube.com) to follow along and get explanations of the different plugins we are configuring.
